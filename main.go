	...
	for _, event := range events {
		...
		if event.Type == linebot.EventTypeMessage {
			...
			case *linebot.TextMessage:
				...
				var msg = event.Source.UserID + event.Source.GroupID + event.Source.RoomID + ":"
				...
				if strings.Contains(message.Text, "資金盤") {
					msg += "資金盤與資金流的差別:\r\n\r\n1.資金流有具體投資標的及項目，盤金盤則沒有。目前上市櫃股票皆屬資金流。\r\n2.資金盤以拉人頭、做組織純資金堆曡，因無實體造血功能，通常不長久。資金流以實質獲利回饋股東。\r\n3.非法資金盤無實體公司，電源一拔掉，就什麼都沒有了。\r\n4.資金盤短期可以改善生活，但資金流卻長期可以改變你的命運。"
				} 
